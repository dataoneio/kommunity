	...
	getCustomData() {
		...
		firebase
			...
			.then(snapshot => {
				...
				if (this.state.searchResult.length < 6) {
					if (
						...
						<View style={{ flex: 1, flexDirection: "row" }}>
							...
							>
								<View>
									...
									>
										<Text style={styles.drawerOptions}>
											About Us
										</Text>
									</TouchableOpacity>
									<TouchableOpacity
										onPress={this.gotoReportProblem.bind(
											this
										)}
										style={{
											borderBottomWidth: 1,
									...
									{renderIf(
										screenProps.user.number ==
											"917878580099"
									)(
										<TouchableOpacity
											onPress={this.gotojoiningRequests.bind(
												this
											)}
											style={{
												borderBottomWidth: 1,
									...
									{renderIf(
										...
										<TouchableOpacity
											onPress={this.gotoBroadcast.bind(
												this
											)}
											style={{
												borderBottomWidth: 1,
